...
<!--    <div class="preloader">-->
        <!--<img src="/wp-content/uploads/2018/07/loader.gif" alt="NILA">-->
<!--    </div>-->
<!--</div>-->

<nav class="navbar navbar-expand-md navbar-light fixed-top">
  <div class="container">
  <a class="navbar-brand" href="<?php echo esc_url( home_url('/') ); ?>"><img src="/wp-content/uploads/2018/07/Logo.png"></img></a>
